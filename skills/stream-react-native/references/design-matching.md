...
**Composer verification gate (do NOT leave the composer until all pass — the recurring defect). Verify every STATE, not every screen — a state you never render hides its defects (a stray default colour, a broken layout):**
