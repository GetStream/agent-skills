...
**Moderation** is configured via CLI during setup only. **Never build moderation review UI in the app** ([`RULES.md`](RULES.md) > Moderation is Dashboard-only) - review happens in the [Stream Dashboard](https://dashboard.getstream.io).
